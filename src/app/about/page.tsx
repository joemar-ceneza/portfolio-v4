          ...
          <div className="w-full xl:min-h-[70vh]">
            <TabsContent value="about-me" className="w-full text-center xl:text-left">
              <div className="flex flex-col gap-[30px]">
                <h3 className="text-3xl xl:text-4xl font-bold">{about.title}</h3>
            ...
            <TabsContent value="experience" className="w-full">
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                <h3 className="text-3xl xl:text-4xl font-bold">{experience.title}</h3>
                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, idx) => {
                      return (
                        <li
                          key={idx}
                          className="bg-[#232329] min-h-[184px] py-6 px-6 xl:px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
            ...
            <TabsContent value="education" className="w-full">
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                <h3 className="text-3xl xl:text-4xl font-bold">{education.title}</h3>
            ...
            <TabsContent value="skills" className="w-full">
              <div className="flex flex-col gap-[30px]">
                <div className="flex flex-col gap-[30px] text-center xl:text-left">
                  <h3 className="text-3xl xl:text-4xl font-bold">{skills.title}</h3>
